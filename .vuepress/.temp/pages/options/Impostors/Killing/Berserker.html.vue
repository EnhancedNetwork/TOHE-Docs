<template><div><h1 id="🪓-berserker" tabindex="-1"><a class="header-anchor" href="#🪓-berserker" aria-hidden="true">#</a> <font color=red>🪓 <b>Berserker</b></font> <Badge text="Killing" type="tip" vertical="middle"/></h1>
<hr>
<p>As the Berserker, you level up with each kill. Upon reaching a certain level defined by the host, you unlock a new power.<br><br>
Scavenged kills make your kills disappear.<br>
Bombed kills make your kills explode.</p>
<ul>
<li>Max
<ul>
<li>Set the Maximum amount of Berserkers that can be in a match</li>
</ul>
</li>
...
<li>
<font color=red>OFF</font>: Berserker cannot unlock immortality even if they reach a certain level</li>
</ul>
</li>
</ul>
<blockquote>
