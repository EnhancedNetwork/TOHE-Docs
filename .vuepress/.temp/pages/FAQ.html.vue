...
<h2 id="how-to-install-mod-on-mobile-phones-tablets-and-apple" tabindex="-1"><a class="header-anchor" href="#how-to-install-mod-on-mobile-phones-tablets-and-apple"><span>How to install mod on mobile phones, tablets, and Apple</span></a></h2>
...
<h2 id="you-have-been-kicked-by-room" tabindex="-1"><a class="header-anchor" href="#you-have-been-kicked-by-room"><span>You have been kicked by room</span></a></h2>
...
<h2 id="you-have-been-kicked-by-among-us-official-anti-cheat" tabindex="-1"><a class="header-anchor" href="#you-have-been-kicked-by-among-us-official-anti-cheat"><span>You have been kicked by Among Us' official anti-cheat</span></a></h2>
...
<h2 id="your-connection-to-the-server-has-been-interrupted" tabindex="-1"><a class="header-anchor" href="#your-connection-to-the-server-has-been-interrupted"><span>Your connection to the server has been interrupted</span></a></h2>
<p>If you find that other people can play normally, there are two possibilities:</p>
<ol>
<li>
<p>Among Us official servers are overloaded, this situation cannot be avoided.</p>
</li>
<li>
...
<h2 id="unable-to-connect-to-your-among-us-account" tabindex="-1"><a class="header-anchor" href="#unable-to-connect-to-your-among-us-account"><span>Unable to connect to your Among Us account</span></a></h2>
...
<h2 id="the-mod-file-is-damaged-please-restart-the-game-or-reinstall-the-mod" tabindex="-1"><a class="header-anchor" href="#the-mod-file-is-damaged-please-restart-the-game-or-reinstall-the-mod"><span>The mod file is damaged, please restart the game or reinstall the mod</span></a></h2>
<p>There are two possibilities:</p>
<ol>
<li>
<p>There is a problem with your network that causes the mod to fail to check the integrity.</p>
</li>
<li>
<p>The files of the mod or game are deleted or modified artificially or by a program, anti-virus software, etc.
First, please check whether your network is normal, and then please make sure that your network proxy software is not a global proxy. After that, please restart the game. If you still get the same prompt, please try to reinstall your vanilla Among Us files aswell as the mod files.</p>
</li>
</ol>
<h2 id="after-installing-the-mod-it-is-still-in-vanilla" tabindex="-1"><a class="header-anchor" href="#after-installing-the-mod-it-is-still-in-vanilla"><span>After installing the mod, it is still in vanilla</span></a></h2>
<ol>
<li>
...
<h2 id="how-to-get-the-log-file" tabindex="-1"><a class="header-anchor" href="#how-to-get-the-log-file"><span>How to get the log file</span></a></h2>
<p>You have three methods to get log files:</p>
<ol>
<li>
<p>Press <kbd>Ctrl</kbd> + <kbd>F1</kbd> in the game, then you can find the log file on your desktop, the file name starts with <code v-pre>TOHE...</code>.</p>
</li>
<li>
<p>Send the message &quot;/dump&quot; in the game, then you can find the log file on your desktop, the file name starts with <code v-pre>TOHE...</code>.</p>
</li>
<li>
...
<h2 id="test-error-lv-x" tabindex="-1"><a class="header-anchor" href="#test-error-lv-x"><span>Test Error Lv.x</span></a></h2>
<p>Please restart the game.</p>
<h2 id="the-meeting-cannot-be-end-normally-and-the-lower-left-corner-displays-an-error-please-terminate-the-meeting-manually" tabindex="-1"><a class="header-anchor" href="#the-meeting-cannot-be-end-normally-and-the-lower-left-corner-displays-an-error-please-terminate-the-meeting-manually"><span>The meeting cannot be end normally, and the lower left corner displays an error: Please terminate the meeting manually</span></a></h2>
...
<h2 id="the-opening-shows-that-i-am-one-role-team-but-in-game-i-am-a-different-role-team" tabindex="-1"><a class="header-anchor" href="#the-opening-shows-that-i-am-one-role-team-but-in-game-i-am-a-different-role-team"><span>The opening shows that I am one role/team, but in game I am a different role/team</span></a></h2>
...
<h2 id="what-are-the-host-only-mods" tabindex="-1"><a class="header-anchor" href="#what-are-the-host-only-mods"><span>What are the Host-Only mods</span></a></h2>
...
<h2 id="the-game-ends-inexplicably" tabindex="-1"><a class="header-anchor" href="#the-game-ends-inexplicably"><span>The game ends inexplicably</span></a></h2>
...
<ol>
<li>
<p>You have turned on the &quot;Ghost ignores tasks&quot; option and all alive players are finished tasks.</p>
</li>
<li>
<p>You have made the punishment of the &quot;Voting Mode&quot; option to be Suicide, which could have killing all players, leaving Impostors or Neutrals alive to take the win.</p>
</li>
<li>
...
<h2 id="just-after-the-start-it-shows-that-the-host-has-forced-the-end-of-the-game" tabindex="-1"><a class="header-anchor" href="#just-after-the-start-it-shows-that-the-host-has-forced-the-end-of-the-game"><span>Just after the start, it shows that the host has forced the end of the game</span></a></h2>
...
<h2 id="most-of-the-screen-is-black-but-i-can-interact-with-the-gui-and-the-sound-can-still-be-heard" tabindex="-1"><a class="header-anchor" href="#most-of-the-screen-is-black-but-i-can-interact-with-the-gui-and-the-sound-can-still-be-heard"><span>Most of the screen is black, but I can interact with the GUI and the sound can still be heard</span></a></h2>
...
<h2 id="there-are-a-lot-of-duplicate-roles-in-the-game" tabindex="-1"><a class="header-anchor" href="#there-are-a-lot-of-duplicate-roles-in-the-game"><span>There are a lot of duplicate roles in the game</span></a></h2>
<p>This most likely isn't a bug, please make sure the duplicated role has a Maximum of 1 rather than 2-15.</p>
<h2 id="i-got-vanilla-roles" tabindex="-1"><a class="header-anchor" href="#i-got-vanilla-roles"><span>I got vanilla roles</span></a></h2>
...
<li>
<p>You may come accross this message: &quot;There are incompatible roles in your role list, you may experience vanilla roles&quot;, which means you have a certain role &amp; it's addon form enabled, (You can find info on what roles/addons are incompatible on these pages: <RouteLink to="/options/Crewmates/Vanilla/Crewmate.html">Crewmate</RouteLink> | <RouteLink to="/options/Crewmates/Vanilla/Engineer.html">Engineer</RouteLink> | <RouteLink to="/options/Crewmates/Vanilla/Scientist.html">Scientist</RouteLink>) (This should not occur anymore as of 1.2.1 dev 3)</p>
</li>
<li>
...
<h2 id="the-game-never-ends" tabindex="-1"><a class="header-anchor" href="#the-game-never-ends"><span>The game never ends</span></a></h2>
<p>There are a few possibilities,</p>
<ol>
<li>
<p>You have enabled &quot;No Game End&quot; in settings. Please turn it off to play normally.</p>
</li>
<li>
<p>If there is equal amount of Crewmates to Impostors, a Crewmate may have the Scizophrenic addon (count as 2 people)</p>
</li>
<li>
<p>If Cultist is enabled, you might have &quot;Charmed players count as&quot; set to Cultist. You need to have it set to Nothing (They will not count as an Alive player) or Original Team (They will count as their Original Team), as setting it to Cultist means that Charmed players are counted as another alive Cultist. (they wont have recruiting powers like Cultist but game will treat them like they are Cultist.)</p>
</li>
<li>
...
<ol>
<li>
<p>Become a Translator, Sponsor (Initiate+), or Nitro Booster for Canary Access.</p>
</li>
<li>
<p>Become a Contributor, Tester, or Sponsor (Insider+) for Canary <i>and</i> Dev Access.<br>
Read near the bottom of the <RouteLink to="/GetStarted.html">Install/Get Started</RouteLink> page.</p>
</li>
</ol>
