...
<li>
<p>Once the download is complete, unzip it into the location of your choice. Example: C:\TOHRE</p>
</li>
<li>
...
<li>
<p>Select all of the files in your AmongUs installation and copy them to the folder that now has the files from the TOHRE release. The folder should now look something like this:
<img src="@source/images/ResultFolder.png" alt="image"></p>
</li>
<li>
<p>Within the TOHRE folder, run Among Us.exe. The first time running it may take some time while the mod sets up its files. If you see a black screen, just wait a couple minutes. Once it finishes loading, you should get a popup with TOHRE news. If you do not see anything about TOHE, double check that your files are all in the same folder.</p>
</li>
</ol>
