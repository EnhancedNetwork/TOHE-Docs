<template><div><h1 id="🦹-nemesis" tabindex="-1"><a class="header-anchor" href="#🦹-nemesis" aria-hidden="true">#</a> <font color="red">🦹 Nemesis</font> <Badge text="Support" type="tip" vertical="middle"/></h1>
<hr>
<p>Nemesis cannot kill if their <font color=red>Impostor</font> teammate is alive. They can use their Revenge command <code v-pre>/rv {ID}</code> after death to kill a few people.</p>
<ul>
<li>Max
<ul>
