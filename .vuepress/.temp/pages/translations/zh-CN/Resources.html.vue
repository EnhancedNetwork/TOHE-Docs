...
<p>Here are some Resources that may help you understand some things relating to the mod. Such as Hot-Keys, Commands, Template/Preset Help, and other Useful Resources.</p>
<font size=3em>
<details>
...
<p>Below is a list of commands that you can use to make your experience better while playing TOHE. You can use these commands in the chat box to perform certain actions.<br><br></p>
...
<img src="@source/translations/images/TemplateTitle.png" alt="image"></li>
...
<img src="@source/translations/images/TemplateNewLines.png" alt="image"></p>
<blockquote>
...
<img src="@source/translations/images/HostTextDefault.png" alt="image"><br>
Versus what the edited <code v-pre>english.dat</code> I have looks like.<br>
<img src="@source/translations/images/HostTextEdited.png" alt="image"><br><br></p>
...
<p>For some member submitted translations (not yet supported by TOHE/Base game Among Us), browse <RouteLink to="/Translations.html">here</RouteLink><br></p>
<blockquote>
...
<li><code v-pre>{{ModVersion}}</code> - Displays the current version of TOHE.</li>
...
<p>You can find the <i>original</i> Hex Codes of TOHE Roles <a href="https://github.com/0xDrMoe/TownofHost-Enhanced/blob/main/Resources/roleColor.json" target="_blank" rel="noopener noreferrer">Here<ExternalLinkIcon/></a>.<br><br></p>
<blockquote>
...
<p>For some member submitted presets, browse <RouteLink to="/Presets.html">here</RouteLink></p>
<blockquote>
<p>From + Compiling: NotPyro404</p>
</blockquote>
</details>
