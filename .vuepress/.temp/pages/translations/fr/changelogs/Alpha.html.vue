...
+ <font color=green><b>NEW</b></font>: Neutral Chaos Role: <RouteLink to="/options/Chaos/Neutral/Troller.html">Troller</RouteLink> (Idea by: <code v-pre>@dx7405</code>)<br>
...
+ <font color=green><b>NEW</b></font>: Helpful Add-on: <RouteLink to="/options/Helpful/Addons/Spurt.html">Spurt</RouteLink> (Idea by: <code v-pre>@.thediamondstar</code>)<br>
