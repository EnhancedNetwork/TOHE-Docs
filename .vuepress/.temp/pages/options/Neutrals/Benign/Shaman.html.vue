<template><div><h1 id="🧙-shaman" tabindex="-1"><a class="header-anchor" href="#🧙-shaman"><span><font color="#50c878">🧙 <b>Shaman</b></font> <Badge text="Benign" type="tip" vertical="middle"/></span></a></h1>
<hr>
...
<li>Max
<ul>
<li>Set the Maximum amount of Shamans that can be in a match</li>
</ul>
</li>
<li>Voodoo Cooldown
<ul>
<li>Set the cooldown of the voodoo doll</li>
</ul>
</li>
</ul>
<blockquote>
