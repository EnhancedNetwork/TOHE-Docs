...
<p>Here you can browse through Common Questions relating to Town of Host: Enhanced. These can vary from general questions, to troubleshooting.</p>
<p>Other general help related pages can be found at <RouteLink to="/Install.html">Install</RouteLink> (For installation issues/questions) as well as <RouteLink to="/Resources.html">Resources</RouteLink> (For other information).</p>
<font size=4em>
<details>
<summary><b><font color=gray>How can I Install Town of Host: Enhanced?</font></b></summary>
<p>Visit the <RouteLink to="/Install.html">Install</RouteLink> page! This guides you through installing Town of Host: Enhanced on either Steam, Epic, or Xbox App, and also shows you how to install Alpha &amp; Beta Builds.</p>
</details>
<br>
<details>
...
<p>This can randomly happen due to errors in the code. re-installing TOHE + re-pasting your Vanilla Among Us files will allow you to play again. If this happens constantly, please be patient as Developers are aware of this error. PS: Make sure you copy important files before re-installing (such as files in your Language folder, TOHE-Data folder, etc).</p>
</details>
<br>
<details>
...
<p>There are a few possibilities such as having bad network strength, changing your VPN/VPN instability may also cause this problem. Some solutions are to restart the game, restart the VPN, restarting your router, or restarting the computer entirely.</p>
</details>
<br>
<details>
...
<p>Unfortunately, this is a disconnection caused by a mod error or server error. If possible, please send the logs in a #bug-report to solve the problem as soon as possible. Of course, this does not rule out your network reasons.</p>
</details>
<br>
<details>
<summary><b><font color=gray>Could not connect to my Among Us account, why?</font></b></summary>
<p>This problem could occur from a few causes:</p>
<ol>
<li>
<p>Steam isn't running! Go and turn on the Steam app, wait for it to load, THEN run modded Among Us.</p>
</li>
<li>
<p><code v-pre>steam_appid.txt</code> is missing from the modded folder! Copy it from the vanilla Among Us folder, and paste it into your modded folder.</p>
</li>
</ol>
</details>
<br>
...
<ol>
<li>
<p>Steam is down! Steam goes down for maintenance every Tuesday at around 7:00PM EST. You will not be able to sign in during this maintenance period. (This may also result in getting the <code v-pre>SteamworksAuthFail</code> error)</p>
</li>
<li>
<p>Console is still starting up! Click nothing and just wait until it clears out. If it doesn't, see the two below.</p>
</li>
<li>
<p>Your PC is Slow/Bad! Slow or Old PCs will just experience this. Nothing we can do about it, This is a vanilla issue.</p>
</li>
<li>
<p>Login just hung up! If this happens, just click &quot;Go Offline&quot; then try signing in again. It should work. If it doesn't, see the three above.</p>
</li>
</ol>
</details>
<br>
...
<p>This is due to some bugs in the meeting billing that prevent the meeting from ending normally. Please press <kbd>Shift</kbd> + <kbd>M</kbd> + <kbd>Enter</kbd> to end the meeting forcefully. If possible, please send the log file in #bug-reports so that the developers can solve the problem as soon as possible.</p>
</details>
<br>
<details>
...
<li>
<p>You may come across this message: &quot;There are incompatible roles in your role list, you may experience vanilla roles&quot;, which means you have a certain role &amp; it's addon form enabled. (This should not occur anymore as of 1.2.1 Alpha 3)</p>
</li>
<li>
...
<li>
<p>If there is equal amount of Crewmates to Impostors, a Crewmate may have the Paranoia addon (count as 2 people)</p>
</li>
<li>
...
<ol>
<li>
<p>Anybody can get Beta Access by visiting <code v-pre>#beta-builds</code> in TEN's Discord Server.</p>
</li>
<li>
<p>Become a Contributor, Tester, or Sponsor (Insider+) for Alpha Access.<br>
...
<p>Role Ideas are currently locked to Sponsors, Nitro Boosters, &amp; Contributors. This is so that the Developers/Contributors of Town of Host: Enhanced can catch up on role ideas. The channel will open back up at a later date, but there's not a specific time.</p>
</details>
<br>
<details>
<summary><b><font color=gray>How do I become Contributor or Translator?</font></b></summary>
<p>Keep in mind, both of these require you to add significant changes, it can't just be a &quot;one and done&quot; sort of deal. If you are an inactive Contributor/Translator, you may be removed from the team.</p>
<ol>
<li>
<p>To earn Contributor, you'll need to help with coding Features, Roles, Game-modes, and so on for Town of Host: Enhanced. To do this, you will need a token. You can obtain one of these by creating a ticket in TEN's Discord Server and asking for an API Token. Moe will get back to you at some point.</p>
</li>
<li>
<p>To earn Translator, you'll need to help with translating Town of Host: Enhanced into other languages supported by Among Us (See supported languages on the Resources Page). If you want to translate a language that Town of Host: Enhanced hasn't yet started, you may create a ticket applying for the position (of course, it will only be you unless other people apply for the same position) and wait for Ryuk or Moe to get back to you. If you want to translate Town of Host: Enhanced into another language but Among Us doesn't yet support it, you can do that in your own english.dat file and share it in #website-feedback when you are finished. (Info on english.dat on the Resources Page.)</p>
</li>
</ol>
</details>
<br>
