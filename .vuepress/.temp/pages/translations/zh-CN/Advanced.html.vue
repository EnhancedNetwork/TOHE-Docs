<template><div><h2 id="hotkeys" tabindex="-1"><a class="header-anchor" href="#hotkeys"><span>HotKeys</span></a></h2>
<table>
<tr>
...
<h2 id="chat-commands" tabindex="-1"><a class="header-anchor" href="#chat-commands"><span>Chat Commands</span></a></h2>
...
<p>Note: Commands in bold are considered &quot;essential&quot; and are recommended for all players.</p>
<table>
<tr>
<td colspan="3" align="center">
<strong style="font-size: 25px">
...
<h2 id="presets" tabindex="-1"><a class="header-anchor" href="#presets"><span>Presets</span></a></h2>
...
<h2 id="welcome-onfirstmeeting-onmeeting-auto-messages" tabindex="-1"><a class="header-anchor" href="#welcome-onfirstmeeting-onmeeting-auto-messages"><span>Welcome, onFirstMeeting &amp; onMeeting auto messages</span></a></h2>
...
<li><code v-pre>{{NumCommonTasks}}</code>  <code v-pre>{{NumLongTasks}}</code> <code v-pre>{{NumShortTasks}}</code></li>
<li><code v-pre>{{AmongUsVersion}}</code> <code v-pre>{{InternalVersion}}</code></li>
<li><code v-pre>{{NumEmergencyMeetings}}</code> <code v-pre>{{EmergencyCooldown}}</code></li>
...
<hr>
<h2 id="ban-list-banned-words-banned-names" tabindex="-1"><a class="header-anchor" href="#ban-list-banned-words-banned-names"><span>Ban list, Banned Words &amp; Banned Names</span></a></h2>
