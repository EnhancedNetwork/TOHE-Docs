<template><div><h1 id="frequently-asked-questions" tabindex="-1"><a class="header-anchor" href="#frequently-asked-questions"><span><font color=#f0b6d5>Frequently Asked Questions</font></span></a></h1>
<p>Welcome to the FAQ! Here, you can browse through Common Questions relating to Town of Host: Enhanced. For Troubleshooting, head to our <RouteLink to="/Troubleshooting.html">Troubleshooting</RouteLink> page.</p>
<font size=3em>
<details>
...
<ol>
<li>
<p>Anybody can get Beta Access by visiting <code v-pre>#tohe-beta</code> in TEN's Discord Server.</p>
</li>
<li>
<p>Become a Contributor, Tester, or Sponsor (Insider+) for Alpha Access.</p>
</li>
</ol>
</details>
<details>
