<template><div><h1 id="advanced" tabindex="-1"><a class="header-anchor" href="#advanced" aria-hidden="true">#</a> Advanced</h1>
<h2 id="hotkeys" tabindex="-1"><a class="header-anchor" href="#hotkeys" aria-hidden="true">#</a> HotKeys</h2>
<p>Table will be updated soon with organized hotkeys.</p>
<table>
<tr>
...
<h2 id="chat-commands" tabindex="-1"><a class="header-anchor" href="#chat-commands" aria-hidden="true">#</a> Chat Commands</h2>
...
<li>template.txt: Message template（[above](#Welcome &amp; onMeeting auto messages)）- You can modify the welcome message and onMeeting message here</li>
</ul>
</div></template>
