<template><div><h1 id="troubleshooting" tabindex="-1"><a class="header-anchor" href="#troubleshooting"><span><font color=#f0b6d5>Troubleshooting</font></span></a></h1>
<p>Are you having issues? You've come to the right place. This is the Troubleshooting page that will help you fix whatever issues you are having!<br>
If your issue is not listed here, or nothing seems to work, join our <a href="discord.gg/ten">Discord</a> and head to the <code v-pre>#mod-help</code> channel for further assistance!</p>
<details>
...
<li>
<p>You may come across this message: &quot;There are incompatible roles in your role list, you may experience vanilla roles&quot;, which means you have a certain role &amp; its addon form enabled. (This should not occur anymore as of 1.2.1 Alpha 3)</p>
</li>
<li>
