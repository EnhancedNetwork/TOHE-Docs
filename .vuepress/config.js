  ...
  theme: defaultTheme({
    locales: {
      '/': {
        ...
        sidebar: {
          '/guides/': [
            { text: 'Guide to TOHE', link: '/guide' },
            { text: 'Welcome to TOHE', link: '/guides/welcome' },
            {
              text: 'Installing TOHE', link: '/guides/installation', children: [
                { text: 'Steam Installation', link: '/guides/install/steam' },
                { text: 'Epic Games Installation', link: '/guides/install/epicgames' },
                { text: 'Xbox App Installation', link: '/guides/install/xboxapp' },
                { text: 'Thunderstore/r2modman Installation', link: '/guides/install/thunderstore' },
                { text: 'Mod Manager Installation', link: '/guides/install/modmanager' }
              ]
            },
            { text: 'Setting Up TOHE', link: '/guides/setup' },
            { text: 'Updating TOHE', link: '/guides/updating' },
            { text: 'Prime Features in TOHE', link: '/guides/features' },
            { text: 'All About Presets', link: '/guides/presets' },
            { text: 'All About TOHE-Data', link: '/guides/tohedata' },
            { text: 'All About Templates', link: '/guides/templates' },
            { text: 'All About Tags', link: '/guides/templates' },
            { text: 'All About Gamemodes', link: '/guides/templates' }
          ],
          '/changelogs/': [
            { text: 'Latest Changelogs', link: '/changelogs' },
            { text: 'Changelogs Tags', link: '/changelogs/tags' },
            { text: 'All Stable Changelogs', link: '/changelogs/stable' },
            { text: 'All Beta Changelogs', link: '/changelogs/beta' },
            { text: 'All Alpha Changelogs', link: '/changelogs/alpha' }
          ],
          '/options/Addons/Experimental/': [
            ...
            { text: 'Swift', link: '/options/addons/experimental/swift' }
          ],
          '/options/Addons/Guesser/': [
            { text: 'Back to Addons', link: '/options/settings/addons' },
            { text: 'Double Shot', link: '/options/addons/guesser/doubleshot' },
            { text: 'Guesser', link: '/options/addons/guesser/guesser' },
            { text: 'Onbound', link: '/options/addons/guesser/onbound' },
            { text: 'Rebound', link: '/options/addons/guesser/rebound' }
          ],
          '/options/Addons/Harmful/': [
            ...
            { text: 'Prohibited', link: '/options/addons/harmful/prohibited' },
            { text: 'Rascal', link: '/options/addons/harmful/rascal' },
            { text: 'Sloth', link: '/options/addons/harmful/sloth' },
          ...
          '/options/Addons/Helpful/': [
            ...
            { text: 'Eavesdropper', link: '/options/addons/helpful/eavesdropper' },
            { text: 'Evader', link: '/options/addons/helpful/evader' },
            ...
            { text: 'Rebirth', link: '/options/addons/helpful/rebirth' },
          ...
          '/options/Coven/Killing/': [
            { text: 'Back to Coven', link: '/options/settings/coven' },
            { text: 'Conjurer', link: '/options/coven/killing/conjurer' },
            { text: 'Hex Master', link: '/options/coven/killing/hexmaster' },
            { text: 'Jinx', link: '/options/coven/killing/jinx' }
          ],
          '/options/Coven/Power/': [
            { text: 'Back to Coven', link: '/options/settings/coven' },
            { text: 'Coven Leader', link: '/options/coven/power/covenleader' },
            { text: 'Ritualist', link: '/options/coven/power/ritualist' }
          ],
          '/options/Coven/Trickery/': [
            { text: 'Back to Coven', link: '/options/settings/coven' },
            { text: 'Dreamweaver', link: '/options/coven/trickery/dreamweaver' },
            { text: 'Illusionist', link: '/options/coven/trickery/illusionist' },
            { text: 'Poisoner', link: '/options/coven/trickery/poisoner' }
          ],
          '/options/Coven/Utility/': [
            { text: 'Back to Coven', link: '/options/settings/coven' },
            { text: 'Harvester', link: '/options/coven/utility/harvester' },
            { text: 'Medusa', link: '/options/coven/utility/medusa' },
            { text: 'Moon Dancer', link: '/options/coven/utility/moondancer' },
            { text: 'Necromancer', link: '/options/coven/utility/necromancer' },
            { text: 'Potion Master', link: '/options/coven/utility/potionmaster' },
            { text: 'Sacrifist', link: '/options/coven/utility/sacrifist' },
            { text: 'Voodoo Master', link: '/options/coven/utility/voodoomaster' }
          ],
          '/options/Crewmates/Basic/': [
            ...
            { text: 'Lazy Guy', link: '/options/crewmates/basic/lazyguy' },
            {
              text: 'Mini', link: '/options/crewmates/basic/mini', children: [
                { text: 'Evil Mini', link: '/options/crewmates/secondary/minievil' },
                { text: 'Nice Mini', link: '/options/crewmates/secondary/mininice' }
              ]
            },
          ...
          '/options/Crewmates/Killing/': [
            ...
            {
              text: 'Knight', link: '/options/crewmates/killing/knight', children: [
                { text: 'Requiter', link: '/options/crewmates/secondary/requiter' },
              ]
            },
          ...
          '/options/Crewmates/Power/': [
            ...
            { text: 'Chief Of Police', link: '/options/crewmates/power/chiefofpolice' },
          ...
          '/options/Crewmates/Support/': [
            { text: 'Back to Crewmates', link: '/options/settings/crewmates' },
            { text: 'Altruist', link: '/options/crewmates/support/altruist' },
            ...
            { text: 'Ventguard', link: '/options/crewmates/support/ventguard' },
          ...
          '/options/Impostors/Concealing/': [
            ...
            { text: 'Abyssbringer', link: '/options/impostors/concealing/abyssbringer' },
            ...
            { text: 'Vampire', link: '/options/impostors/concealing/vampire',},
          ...
          '/options/Impostors/Ghost/': [
            ...
            { text: 'Possessor', link: '/options/impostors/ghost/possessor' },
          ],
          ...
          '/options/Impostors/Killing/': [
            { text: 'Back to Impostors', link: '/options/settings/impostors' },
            {
              text: 'Arrogance', link: '/options/impostors/killing/arrogance', children: [
                { text: 'Bard', link: '/options/impostors/secondary/bard' },
              ]
            },
            { text: 'Bomber', link: '/options/impostors/killing/bomber' },
            ...
            { text: 'YinYanger', link: '/options/impostors/killing/yinyanger' },
          ...
          '/options/Impostors/Support/': [
            ...
            { text: 'Double Agent', link: '/options/impostors/support/doubleagent' },
          ...
          '/options/Neutrals/Benign': [
            ...
            { text: 'Provocateur', link: '/options/neutrals/benign/provocateur' },
            { text: 'Pursuer', link: '/options/neutrals/benign/pursuer' },
            { text: 'Revenant', link: '/options/neutrals/benign/revenant'},
            {
              text: 'Romantic', link: '/options/neutrals/benign/romantic', children: [
                { text: 'Vengeful Romantic', link: '/options/neutrals/secondary/romanticvengeful' },
                { text: 'Ruthless Romantic', link: '/options/neutrals/secondary/romanticruthless' },
              ]
            },
            ...
            { text: 'Troller', link: '/options/neutrals/benign/troller' },
          ],
          ...
          '/options/Neutrals/Evil/': [
            ...
            { text: 'Innocent', link: '/options/neutrals/evil/innocent' },
            {
              text: 'Jester', link: '/options/neutrals/evil/jester', children: [
                { text: 'Sunnyboy', link: '/options/neutrals/secondary/sunnyboy' },
              ]
            },
          ...
          '/options/Neutrals/Experimental/': [
            ...
            { text: 'Shocker', link: '/options/neutrals/experimental/shocker' },
          ],
          '/options/Neutrals/Killing/': [
            ...
            { text: 'Cultist', link: '/options/neutrals/killing/cultist' },
          ...
          '/options/Settings/': [
            ...
            { text: 'Coven', link: '/options/settings/coven' },
