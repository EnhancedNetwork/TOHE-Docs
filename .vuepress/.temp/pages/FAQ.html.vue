...
<p>Make sure you are on the latest version. The latest on our GitHub (TOHE v1.6.0) doesn't work by itself anymore. Among Us has updated a lot of things which makes TOHE broken. If you wish to play TOHE again, download the latest canary build in the #canary-builds channel. For help with doing that, read the <RouteLink to="/Install.html">Install</RouteLink> page. (This Question is only here until <code v-pre>v2.0.0 Stable</code> is released)</p>
</details>
<br>
<details>
